...
function Clothes() {
    ...
    const clothesData = {
        women: [
            { name: "Women's Dress 1", img: "/d1.png", price: "10,000 FRW", phone: "+250 788 706 386" },
            { name: "Women's Dress 2", img: "/d2.png", price: "5,000 FRW", phone: "+250 788 386" }
        ],
        men: [
            { name: "Men's Shirt 1", img: "/t2.png", price: "10,000 FRW", phone: "250 788 386" }
        ],
        others: [
            { name: "Jumper", img: "/jumper1.png", price: "10,000 FRW", phone: "+250 788 386" },
            { name: "Skirt 1", img: "/skirt1.png", price: "5,000 FRW", phone: "+250 788 386" },
            { name: "Skirt 2", img: "/skirt2.png", price: "5,000 FRW", phone: "+250 788 386" },
            { name: "T-Shirt 1", img: "/t1.png", price: "5,000 FRW", phone: "+250 788 386" },
            { name: "T-Shirt 2", img: "/t3.png", price: "5,000 FRW", phone: "+250 788 386" }
        ]
    };
