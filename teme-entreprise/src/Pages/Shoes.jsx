...
function Shoes() {
    ...
    const shoesData = [
        { name: "Women's Shoe 1", img: "/s1.png", price: "10,000 FRW", phone: "+250 787 902 373" },
        { name: "Women's Shoe 2", img: "/s2.png", price: "5,000 FRW", phone: "+250 787 902 373" },
        { name: "Women's Shoe 3", img: "/s4.png", price: "5,000 FRW", phone: "+250 787 902 373" },
        { name: "Men's Shoe 1", img: "/s3.png", price: "10,000 FRW", phone: "+250 787 902 373" }
    ];
